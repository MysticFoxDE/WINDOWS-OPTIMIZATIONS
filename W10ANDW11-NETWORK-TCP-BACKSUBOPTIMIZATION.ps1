...
# SET RSS TO DEFAULT
netsh int tcp Set-Variable global RSS=Enabled
Set-NetOffloadGlobalSetting -ReceiveSideScaling Enabled

# SET RSC TO DEFAULT
netsh int tcp Set-Variable global RSC=Enabled
...
netsh int tcp Set-Variable supplemental template=Datacenter congestionprovider=CUBIC
netsh int tcp Set-Variable supplemental template=Datacentercustom congestionprovider=CUBIC
netsh int tcp Set-Variable global ECN=Disabled
