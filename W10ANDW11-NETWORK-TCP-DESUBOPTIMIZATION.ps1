...
Get-NetAdapterAdvancedProperty | Format-Table -AutoSize >> $BAKLOGPATH\$BAKLOGFILENAME
"------------------------------------------------------------------------------------------------------------" >> $BAKLOGPATH\$BAKLOGFILENAME
"Get-NetAdapterRsc:" >> $BAKLOGPATH\$BAKLOGFILENAME
Get-NetAdapterRsc | Format-Table -AutoSize >> $BAKLOGPATH\$BAKLOGFILENAME
"------------------------------------------------------------------------------------------------------------" >> $BAKLOGPATH\$BAKLOGFILENAME
...
{
  $NICGUID = $adapter | Select-Object DeviceID | Select-Object DeviceID -ExpandProperty DeviceID | Out-String -Stream
  $NICNAME = $adapter | Select-Object Name | Select-Object Name -ExpandProperty Name | Out-String -Stream
...
$STATUSPCF = Get-NetOffloadGlobalSetting | Select-Object PacketCoalescingFilter | Select-Object PacketCoalescingFilter -ExpandProperty PacketCoalescingFilter | Out-String -Stream
...
$STATUSRSS = Get-NetOffloadGlobalSetting | Select-Object ReceiveSideScaling | Select-Object ReceiveSideScaling -ExpandProperty ReceiveSideScaling | Out-String -Stream
...
$STATUSRSC = Get-NetOffloadGlobalSetting | Select-Object ReceiveSegmentCoalescing | Select-Object ReceiveSegmentCoalescing -ExpandProperty ReceiveSegmentCoalescing | Out-String -Stream
...
$NICsWITHRSS = $NICs | Measure-Object -Line | Select-Object Lines | Select-Object Lines -ExpandProperty Lines
...
else
{
  ...
  {
    $NICNAME = $adapter | Select-Object Name | Select-Object Name -ExpandProperty Name | Out-String -Stream
    $RSSVALUE = $adapter | Select-Object RegistryValue | Select-Object RegistryValue -ExpandProperty RegistryValue | Out-String -Stream
...
$NICsWITHRSCIPV4 = $NICs | Measure-Object -Line | Select-Object Lines | Select-Object Lines -ExpandProperty Lines
...
else
{
  ...
  {
    $NICNAME = $adapter | Select-Object Name | Select-Object Name -ExpandProperty Name | Out-String -Stream
    $RSCVALUE = $adapter | Select-Object RegistryValue | Select-Object RegistryValue -ExpandProperty RegistryValue | Out-String -Stream
...
$NICsWITHRSCIPV6 = $NICs | Measure-Object -Line | Select-Object Lines | Select-Object Lines -ExpandProperty Lines
...
{
  $NICNAME = $adapter | Select-Object Name | Select-Object Name -ExpandProperty Name | Out-String -Stream
  $EEEVALUE = $adapter | Select-Object RegistryValue | Select-Object RegistryValue -ExpandProperty RegistryValue | Out-String -Stream
